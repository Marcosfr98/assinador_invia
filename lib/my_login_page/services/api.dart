...
class MyLoginServiceApi extends ChangeNotifier {
  ...
  Future<void> login({
    ...
    final endpoint = Uri.parse("https://invianf.com.br/ws/appAssinador/login.php");
    ...
    if (response.statusCode == 200) {
      await _localPersistance.setData(key: "isLoggedIn", value: true, type: TypeVariable.bool);
      Get.offAll(() => MyHomePage(), transition: Transition.upToDown);
      print(response.body);
    } else if (response.statusCode != 200) {
      await EasyLoading.showError("Erro ao fazer login!\nVerifique as credencias e tente novamente.");
    }
  }
}
