      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Scaffold(
                          ...
                          : _myHomePageController.currentIndex == 0
                              ? IconButton(
                                  onPressed: () async {
                                    ...
                                    Get.offAll(() => MyLoginPage(), transition: Transition.fadeIn);
                                  },
                                  icon: CircleAvatar(
            ...
            drawer: _myHomePageController.currentIndex == 0 ? DrawerWidget() : null,
            body: Stack(
              children: [
      ...
      bottomNavigationBar: Container(
        ...
        child: Center(
          child: ElevatedButton(
            ...
            onPressed: () async {
              try {
                String? hashId = base64Encode(
                  utf8.encode(
                    widget.item.idassinatura,
                  ),
                );
                await launchUrl(
                  Uri.parse("https://invianf.com.br/inviassinador/signatureDetails.php?code=${hashId}"),
